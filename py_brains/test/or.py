...
from src.networkx_graphs import NetworkXGraphs
...
def get_training_data():
    ...
    for i in range(200):
        ...
        expected.append([1.0 if i % 3 == 0 or i % 5 == 0 else 0.0])
...
def main():
    ...
    nn = NeuralNet([2, 4, 3, 2, 1, 1], True)

    nn.train(training_data[0], training_data[1], 2000)

    graph = NetworkXGraphs(nn)
