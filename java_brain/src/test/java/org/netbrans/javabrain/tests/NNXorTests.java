...
public class NNXorTests {
    ...
    public void init() {
        ...
        for(List<Double> i : inputVectors) {
            ...
            boolean condition = (i.get(0) == 1.0 && i.get(1) == 0.0) ||
                    (i.get(0) == 0.0 && i.get(1) == 1.0);
            ex.add(condition ? 1.0 : 0.0);
            expected.add(ex);
        }
    }

    @Test
    public void shouldBe_0_inputs_1_1() {
        // Arrange
    ...
    @Test
    public void shouldBe_1_inputs_1_0() {
        // Arrange
        List<Double> inputs = new ArrayList<>();
        inputs.add(1.0);
        inputs.add(0.0);
    ...
    @Test
    public void shouldBe_1_inputs_0_1() {
        // Arrange
        List<Double> inputs = new ArrayList<>();
        inputs.add(1.0);
        inputs.add(0.0);
        ...
        // Assert
        for(double o : actual) {
            System.out.println("0.0 and 1.0 " + o);
            Assert.assertEquals(Math.round(o), 1.0);
        }
    }
